...
using VayneHunter_Reborn.ProfileSelector.DefaultProfiles;
using VayneHunter_Reborn.ProfileSelector.ProfileValues;
...
namespace VayneHunter_Reborn.ProfileSelector
{
    internal class ProfileSelector
    {
                        ...
                        if (args.GetNewValue<bool>())
                        {
                            try
                            {
                                ...
                                if (index < 6)
                                {
                                    ...
                                    VayneHunterReborn.Menu.Item("dz191.vhr.ps.profile")
                    ...
                    (sender, args) =>
                    {
                        if (args.GetNewValue<bool>())
                        {
                            ...
                            LeagueSharp.Common.Utility.DelayAction.Add(
                                ...
                                {
                                    VayneHunterReborn.Menu.Item("dz191.vhr.ps.showdesc").SetValue(false);
                                });
                        }
                    };
                    ...
                    (sender, args) =>
                    {
                        if (args.GetNewValue<bool>())
                        {
                            ...
                            else
                            {
                               ...
                               (int)(Game.Ping / 2f + 250f), () =>
                               {
                                   VayneHunterReborn.Menu.Item("dz191.vhr.ps.delete").SetValue(false);
                               });
                            }
                        }
                    };
        ...
        static void Game_OnInput(GameInputEventArgs args)
        {
            ...
            if (args.Input.StartsWith(".rename"))
            {
                ...
                if (!c.IsDefault)
                {
                    ...
                    var sList = Profiles.Select(s => s.ProfileName).ToArray();
                    VayneHunterReborn.Menu.Item("dz191.vhr.ps.profile").SetValue(new StringList(sList, currentlySel));
                    SaveCurrentlySelected();
                    SaveAssociations();
                    Save();
                }
        ...
        public static void LoadProfile(ProfileSettings P)
        {
            if (P != null)
            {
                foreach (var option in P.Options)
                {
                   ...
                   // continue;
                    var menuItem = VayneHunterReborn.Menu.Item(option.getMenuName());
                    if (menuItem != null)
                    {
        ...
        public static List<ProfileOption> GetOptions()
        {
            return new List<ProfileOption>
            {
                ...
                new ProfileOption
                {
                    ...
                    BoolValue = MenuHelper.isMenuEnabled("dz191.vhr.misc.tumble.smartq")
                },
                new ProfileOption
                {
                    MajorCategory = MajorCategories.Tumble,
                    ...
                    ValueType = ValueTypes.Boolean,
                    BoolValue = MenuHelper.isMenuEnabled("dz191.vhr.misc.tumble.noaastealth")
                },
                new ProfileOption
                {
                    MajorCategory = MajorCategories.Tumble,
                    ...
                    ValueType = ValueTypes.Boolean,
                    BoolValue = MenuHelper.isMenuEnabled("dz191.vhr.misc.tumble.noqenemies")
                },
                new ProfileOption
                {
                    MajorCategory = MajorCategories.Tumble,
                    ...
                    ValueType = ValueTypes.Boolean,
                    BoolValue = MenuHelper.isMenuEnabled("dz191.vhr.misc.tumble.dynamicqsafety")
                },
                new ProfileOption
                {
                    MajorCategory = MajorCategories.Tumble,
                    ...
                    ValueType = ValueTypes.Boolean,
                    BoolValue = MenuHelper.isMenuEnabled("dz191.vhr.misc.tumble.qspam")
                },
                new ProfileOption
                {
                    MajorCategory = MajorCategories.Tumble,
                    ...
                    ValueType = ValueTypes.Boolean,
                    BoolValue = MenuHelper.isMenuEnabled("dz191.vhr.misc.tumble.qinrange")
                },
                new ProfileOption
                {
                    MajorCategory = MajorCategories.Tumble,
                    ...
                    ValueType = ValueTypes.Boolean,
                    BoolValue = MenuHelper.isMenuEnabled("dz191.vhr.misc.tumble.mirin")
                },
                new ProfileOption
                {
                    MajorCategory = MajorCategories.Tumble,
                ...
                new ProfileOption
                {
                    ...
                    ValueType = ValueTypes.Boolean,
                    BoolValue = MenuHelper.isMenuEnabled("dz191.vhr.misc.condemn.onlystuncurrent")
                },
                new ProfileOption
                {
                    MajorCategory = MajorCategories.Condemn,
                    ...
                    ValueType = ValueTypes.Boolean,
                    BoolValue = MenuHelper.isMenuEnabled("dz191.vhr.misc.condemn.autoe")
                },
                new ProfileOption
                {
                    MajorCategory = MajorCategories.Condemn,
                    ...
                    ValueType = ValueTypes.Boolean,
                    BoolValue = MenuHelper.isMenuEnabled("dz191.vhr.misc.condemn.eks")
                },
                new ProfileOption
                {
                    MajorCategory = MajorCategories.Condemn,
                ...
                new ProfileOption
                {
                    ...
                    ValueType = ValueTypes.Boolean,
                    BoolValue = MenuHelper.isMenuEnabled("dz191.vhr.misc.condemn.trinketbush")
                },
                new ProfileOption
                {
                    MajorCategory = MajorCategories.Condemn,
                    ...
                    ValueType = ValueTypes.Boolean,
                    BoolValue = MenuHelper.isMenuEnabled("dz191.vhr.misc.condemn.ethird")
                },
                new ProfileOption
                {
                    MajorCategory = MajorCategories.Condemn,
                    ...
                    ValueType = ValueTypes.Boolean,
                    BoolValue = MenuHelper.isMenuEnabled("dz191.vhr.misc.condemn.lowlifepeel")
                },
                new ProfileOption
                {
                    MajorCategory = MajorCategories.Condemn,
                    ...
                    ValueType = ValueTypes.Boolean,
                    BoolValue = MenuHelper.isMenuEnabled("dz191.vhr.misc.condemn.condemnturret")
                },
                new ProfileOption
                {
                    MajorCategory = MajorCategories.Condemn,
                    ...
                    ValueType = ValueTypes.Boolean,
                    BoolValue = MenuHelper.isMenuEnabled("dz191.vhr.misc.condemn.condemnflag")
                },
                new ProfileOption
                {
                    MajorCategory = MajorCategories.Condemn,
                    ...
                    ValueType = ValueTypes.Boolean,
                    BoolValue = MenuHelper.isMenuEnabled("dz191.vhr.misc.condemn.noeturret")
                },
                ...
                new ProfileOption
                {
                    ...
                    ValueType = ValueTypes.Boolean,
                    BoolValue = MenuHelper.isMenuEnabled("dz191.vhr.misc.general.antigp")
                },
                new ProfileOption
                {
                    MajorCategory = MajorCategories.General,
                    ...
                    ValueType = ValueTypes.Boolean,
                    BoolValue = MenuHelper.isMenuEnabled("dz191.vhr.misc.general.interrupt")
                },
                new ProfileOption
                {
                    MajorCategory = MajorCategories.General,
                ...
                new ProfileOption
                {
                    ...
                    ValueType = ValueTypes.Boolean,
                    BoolValue = MenuHelper.isMenuEnabled("dz191.vhr.misc.general.specialfocus")
                },
                new ProfileOption
                {
                    MajorCategory = MajorCategories.General,
                    ...
                    ValueType = ValueTypes.Boolean,
                    BoolValue = MenuHelper.isMenuEnabled("dz191.vhr.misc.general.reveal")
                },
                new ProfileOption
                {
                    MajorCategory = MajorCategories.General,
                    ...
                    ValueType = ValueTypes.Boolean,
                    BoolValue = MenuHelper.isMenuEnabled("dz191.vhr.misc.general.disablemovement")
                },
                new ProfileOption
                {
                    MajorCategory = MajorCategories.General,
                    ...
                    ValueType = ValueTypes.Boolean,
                    BoolValue = MenuHelper.isMenuEnabled("dz191.vhr.misc.general.permashow")
                },
        ...
        private static void ResetItem(String Item, String Message)
        {
            ...
            {
                VayneHunterReborn.Menu.Item(Item).SetValue(false);
            });
        }
        ...
        {
            return VayneHunterReborn.Menu.Item(item).GetValue<T>();
        }
