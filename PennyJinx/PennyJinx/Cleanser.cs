...
namespace PennyJinx
{
    class Cleanser
    {
        ...
        {
            if (Items.HasItem(3140)) PennyJinx.UseItem(3140, Player); //QSS
            if (Items.HasItem(3139)) PennyJinx.UseItem(3139, Player); //Mercurial
            if (Items.HasItem(3137)) PennyJinx.UseItem(3137, Player); //Dervish Blade
        }
